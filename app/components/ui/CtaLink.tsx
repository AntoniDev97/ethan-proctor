...
const CtaLink: React.FC<CtaLinkProps> = ({
  ...
  return (
    <Link
      href={href}
      className={`group cta-pill inline-flex items-center gap-2.5 rounded-full border-2 border-current px-5 py-2 text-eyebrow font-extrabold uppercase tracking-[0.12em] ${className}`}
    >
